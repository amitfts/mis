<div class="row upper-menu" style="height: 35px;">
    ...
    <div style="float:right;">
        <a id="delete-item" class="btn btn-danger users">{{ trans('mis::all.delete') }}</a>
    </div>
</div>
...
<thead>
    <tr>
        ...
        <th style="width:200px;">{{ trans('mis::users.username') }}</th>
        <th style="width:30px; text-align: center;">{{ trans('mis::all.show') }}</th>
    </tr>
</thead>
<tbody>
...
<div class="row">
    ...
    <div class="col-lg-4">
        <button id="add-user" type="button" class="btn btn-primary">{{ trans('mis::groups.add-user') }}</button>
    </div>
</div>
@endif
